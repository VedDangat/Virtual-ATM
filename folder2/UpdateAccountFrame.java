...
import DB.AccountDetailsFetcher;
import java.awt.Dimension;
import java.awt.Toolkit;
import java.util.ArrayList;
import javax.swing.JOptionPane;
import DB.UpdateAccount;
/**
 *
 * @author welcome
 */
public class UpdateAccountFrame extends javax.swing.JFrame {
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        AccountDetailsFetcher df=new AccountDetailsFetcher();
        ArrayList a=df.getDetails(acc_no);

        String acc_type=(String)a.get(1);
        if(acc_type.equals("Saving Account"))
        jRadioButton1.setSelected(true);
        if(acc_type.equals("Current Account"))
        ...
        String adhar_no=(String)a.get(6);
        jTextField5.setText(adhar_no);

        String pan_no=(String)a.get(7);
        jTextField6.setText(pan_no);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            UpdateAccount nac=new UpdateAccount();
            if(nac.doUpdate(acc_no, acc_type, name, address, mobile, email, adhar_no, pan_no))
            JOptionPane.showMessageDialog(null, "Account Updated Successfully");
            else
            JOptionPane.showMessageDialog(null, "Error In Account Updation");
        }
